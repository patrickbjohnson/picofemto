...
<div id="page-error" class="auth-required">
	...
	<section class="page-section page-headline">
		<div class="container center">
			<h1 class="section-header">Forbidden</h1>
			<p class="font-24 light">Sorry. You're forbidden to view this page. If you believe this was done in error please <a href="<?php echo BASE_URL;?>contact">contact us.</a></p>
