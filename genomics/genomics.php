...
<div id="page-genomics">
	...
	<div class="container">
		<section class="page-section">
			<div class="container">
				<div class="row">
					<h1 class="section-header">Medicine should be personalized.</h1>
		...
		<section class="page-section unlock">
			<div class="row">
					<img class="col-md-4 col-md-offset-4 col-xs-12" src="<?php echo BASE_URL;?>img/genomics.svg" alt="#">
		...
		<section class="page-section">
			<div class="container">
				...
				<div class="row center">
					<a class="btn btn-secondary" href="#" data-toggle="modal" data-target="#pico-genomics-email">Sign Me Up</a>
				</div>
			</div>
