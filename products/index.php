	...
	<section class="page-section motivation">
		<div class="jumbotron">
			<div class="container">
				...
				<p>Developing scalable, distributed, and reliable systems requires a very different set of development skills from those necessary to create complex medical data algorithms. Picofemto’s goal is to implement an array of best of breed medical algorithms and to make access to these algorithms simple and efficient for clinicians. As such, the Cliniscan<sup>SM</sup> infrastructure was developed to support this goal, allowing our software engineers and our quantitative developers to work together in harmony. </p>
			</div>
		</div>
	</section>
