...
<div id="page-genomics">
	...
	<div class="container">
		...
		<section class="page-section unlock">
			<div class="row">
					<img class="col-md-4 col-md-offset-4 col-sm-4 col-sm-offset-4 col-xs-12" src="<?php echo BASE_URL;?>img/pico-lock.svg" alt="Unlocking the mysteries of the Human Genome.">
