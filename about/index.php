...
<div id="page-about">
	<div class="jumbotron pico-about">
	  <div class="container">
		...
		<section class="page-mission">
			<div class="row">
				...
				<div class="col-md-4 center mission-col">
					<img class="rounded" src="<?php echo BASE_URL;?>img/mission1.svg" alt="Revolutionize healthcare with an open-architecture medical analytics platform">
				...
				<div class="col-md-4 center mission-col">
					<img class="rounded" src="<?php echo BASE_URL;?>img/mission2.svg" alt="Enable physicians to retrieve, process and store biomedical data utilizing algorithmic analysis.">
				...
				<div class="col-md-4 center mission-col">
					<img class="rounded" src="<?php echo BASE_URL;?>img/mission3.svg" alt="Change the way physicians view, analyze and process biomedical data.">
