			...
			<div class="container">
				<div class="row">
					...
					<div class="col-md-4 center mission-col">
						<img class="rounded" src="<?php echo BASE_URL;?>img/mission1.svg" alt="Alt text!">
					...
					<div class="col-md-4 center mission-col">
						<img class="rounded" src="<?php echo BASE_URL;?>img/mission2.svg" alt="Alt text!">
					...
					<div class="col-md-4 center mission-col">
						<img class="rounded" src="<?php echo BASE_URL;?>img/mission3.svg" alt="Alt text!">
