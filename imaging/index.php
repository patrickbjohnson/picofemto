...
<div id="page-imaging">
	...
	<div class="container">
		...
		<section class="page-section">
			<div class="row">
				<div class="col-md-6">
					<h1 class="section-header font-55 light-300">Problem to be solved</h1>
					<p class="reg-400">One can remember the days when the radiologist would be staring at one printed X-ray image on film. These days are fading away. All data is now digitized. The bulk and complexity of medical images does not allow the radiologist to spend as much time on a single slice as before. For example, a brain MRI can consist of a series of 150 images. From a 2D stack of images of a biological structure, regions of interest can be isolated offline for 2D, 3D and 4D processing, visualization, anomaly detection and clinical correlation.</p>
				</div>
				<div class="col-md-6">
					<img class="col-md-6" src="#" alt="#">
				</div>
		...
		<section class="page-section">
			<div class="row sign-up">
				<p class="bold-700 center font-24">Sign up to be the first to know when our CliniscanSM Genomics product launches</p>
