...
<div id="page-team">
	<div class="jumbotron pico-team">
	  <div class="container">
	    <h1 class="page-title center">Meet The Team</h1>
	  </div>
	</div>
	<div class="container">
		...
		<section class="page-section team-members">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-4 center">
					<img class="rounded" src="<?php echo BASE_URL;?>img/team/dhinakaran@2x.jpg" alt="Dhinakaran Chinappe">
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-4 center">
					<img class="rounded" src="<?php echo BASE_URL;?>img/team/william_c@2x.jpg" alt="William Cheung">
			...
			<div class="row">
				<div class="col-md-4 col-sm-4 center">
					<img class="rounded" src="<?php echo BASE_URL;?>img/team/eric@2x.jpg" alt="Eric Sacks">
		...
		<section class="page-section board-members">
			<div class="row">
